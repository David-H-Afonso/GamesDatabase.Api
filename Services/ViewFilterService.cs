...
public class ViewFilterService : IViewFilterService
{
    ...
    private Expression GetPropertyExpression(ParameterExpression parameter, FilterField field)
    {
        return field switch
        {
            ...
            FilterField.PlayWithId => Expression.Property(parameter, nameof(Game.PlayWithId)),
    ...
    private Expression<Func<Game, object>> GetSortExpression(SortField field)
    {
        return field switch
        {
            ...
            SortField.PlayWithId => g => g.PlayWithId ?? 0,
            SortField.PlayWith => g => g.PlayWith != null ? g.PlayWith.SortOrder : 0,
