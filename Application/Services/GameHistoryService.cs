...
public class GameHistoryService : IGameHistoryService
{
    ...
    public async Task<PagedResult<GameHistoryEntryDto>> GetGameHistoryAsync(int userId, int gameId, int page, int pageSize)
    {
        ...
        return new PagedResult<GameHistoryEntryDto>
        {
    ...
    public async Task<bool> DeleteHistoryEntryAsync(int userId, int gameId, int entryId)
    {
    ...
    public async Task<bool> DeleteAllGameHistoryAsync(int userId, int gameId)
    {
