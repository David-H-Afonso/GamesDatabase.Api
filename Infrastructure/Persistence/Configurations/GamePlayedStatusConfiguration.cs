...
public class GamePlayedStatusConfiguration : IEntityTypeConfiguration<GamePlayedStatus>
{
    public void Configure(EntityTypeBuilder<GamePlayedStatus> entity)
    {
        entity.ToTable("game_played_status");
